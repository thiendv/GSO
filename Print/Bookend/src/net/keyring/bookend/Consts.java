...
/**
 * いくつかの Android Market 定数とサンプルアプリの定数を定義する。<br>
 * Android Market によって定義されている全ての定数は自分のアプリケーションで同じように定義されている必要があります。<br>
 * 
...
public class Consts {
    ...
    public static final String ACTION_CONFIRM_NOTIFICATION =
        "net.keyring.bookend.CONFIRM_NOTIFICATION";
    public static final String ACTION_GET_PURCHASE_INFORMATION =
        "net.keyring.bookend.GET_PURCHASE_INFORMATION";
    public static final String ACTION_RESTORE_TRANSACTIONS =
        "net.keyring.bookend.RESTORE_TRANSACTIONS";
