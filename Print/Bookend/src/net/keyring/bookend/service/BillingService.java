...
import net.keyring.bookend.Consts;
...
import net.keyring.bookend.billing.Base64DecoderException;
import net.keyring.bookend.billing.BillingReceiver;
import net.keyring.bookend.billing.ResponseHandler;
import net.keyring.bookend.billing.Security;
import net.keyring.bookend.billing.Security.VerifiedPurchase;
...
/**
 * MarketBillingService に接続して (binding) 、アプリに代わって Android Market にメッセージを送る<br>
 * 
...
public class BillingService extends Service implements ServiceConnection {
    ...
    abstract class BillingRequest {
        ...
        public boolean runIfConnected() {
            Logput.d(getClass().getSimpleName());
            if (mService != null) {
                try {
                    mRequestId = run();
                    Logput.d("request id: " + mRequestId);
                    if (mRequestId >= 0) {
        ...
        protected void onRemoteException(RemoteException e) {
            Logput.w("remote billing service crashed");
            mService = null;
        }
        ...
        protected Bundle makeRequestBundle(String method) {
            ...
            Logput.d("BILLING_REQUEST_METHOD:" + method);
        ...
        protected void logResponseCode(String method, Bundle response) {
            ...
            Logput.i(method + " received " + responseCode.toString());
        }
    }
    ...
    class CheckBillingSupported extends BillingRequest {
        ...
        protected long run() throws RemoteException {
        	Logput.d("Request:CHECK_BILLING_SUPPORTED");
            Bundle request = makeRequestBundle("CHECK_BILLING_SUPPORTED");
            Bundle response = mService.sendBillingRequest(request);
            int responseCode = response.getInt(Consts.BILLING_RESPONSE_RESPONSE_CODE);
            Logput.i("CheckBillingSupported response code: " +
    ...
    public class RequestPurchase extends BillingRequest {
        ...
        @Override
        protected long run() throws RemoteException {
        	Logput.d("Request:REQUEST_PURCHASE");
            ...
            if (pendingIntent == null) {
                Logput.w("Error with requestPurchase");
                return Consts.BILLING_RESPONSE_INVALID_REQUEST_ID;
            }
    ...
    class ConfirmNotifications extends BillingRequest {
        ...
        @Override
        protected long run() throws RemoteException {
        	Logput.d("Request:CONFIRM_NOTIFICATIONS");
    ...
    class GetPurchaseInformation extends BillingRequest {
        ...
        protected long run() throws RemoteException {
            ...
            Logput.d("Request:GET_PURCHASE_INFORMATION");
    ...
    /**
     * アプリ内購入履歴を問い合わせる
     * ※クラス名変更する場合は注意{@link #checkResponseCode(long, ResponseCode)}
    ...
    /**
     * コンストラクタ - MarketBillingServiceに接続して(binding)、アプリに代わって Android Market にメッセージを送るサービス
     */
    ...
    public void handleCommand(Intent intent, int startId) {
    	try{
	        ...
	        Logput.i("handleCommand() action: " + action + " /startID:" + startId);
	        if (Consts.ACTION_CONFIRM_NOTIFICATION.equals(action)) {
	            ...
	            Logput.d("requestId = " + requestId + " / responseCode = " + responseCode + "(" + responseCodeIndex + ")");
    ...
    private boolean bindToMarketBillingService() {
        try {
            ...
            if (bindResult) {
            	Logput.i("----binding to Market billing service----");
                return true;
            } else {
                Logput.w("Could not bind to service.");
            }
        } catch (SecurityException e) {
            Logput.e("Security exception: " + e);
        }
        return false;
    }
     ...
     * @return false if there was an error connecting to Android Market 接続エラー
     */
    ...
    private void purchaseStateChanged(int startId, String signedData, String signature){
        ...
        try{
        	Logput.i("signedData = " + signedData);
        	purchases = Security.verifyPurchase(getApplicationContext(), signedData, signature);
        	if (purchases == null) {
                return;
            }
    ...
    private void checkResponseCode(long requestId, ResponseCode responseCode) {
        ...
        if (request != null) {
            Logput.d(request.getClass().getSimpleName() + " : " + responseCode);
    ...
    private void runPendingRequests() {
        ...
        // stop it now.
        if (maxStartId >= 0) {
            Logput.i("stopping service, startId: " + maxStartId);
            stopSelf(maxStartId);
        }
    }
	...
	public void onServiceConnected(ComponentName name, IBinder service) {
        Logput.d("Billing service connected-----");
	...
	public void onServiceDisconnected(ComponentName name) {
        Logput.w("Billing service disconnected-----");
        mService = null;
    }
    ...
    public void unbind() {
        try {
            unbindService(this);
            Logput.d("----Billing service unbind----");
        } catch (IllegalArgumentException e) {
        	Logput.w("Billing service unbind fail.");
        }
    }
}
