...
import jp.co.ricoh.ssdk.sample.wrapper.common.*;
...
public class ScanPDF {
    private static final String TAG = ScanPDF.class.getSimpleName();
     ...
     * @param scanJob
     */
    public ScanPDF(ScanJob scanJob) {
        Log.d(TAG, "ScanJob's ID: " + scanJob.getCurrentJobId());
