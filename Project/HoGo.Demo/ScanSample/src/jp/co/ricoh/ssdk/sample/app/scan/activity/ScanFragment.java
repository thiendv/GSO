...
public class ScanFragment extends Fragment {
    ...
    private TextView text_dest_title;
    private ImageView img_dest_icon;
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mButtonDestination.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                AlertDialog dialog = DialogUtil.createDestTypeDialog(getActivity(), mDestSettingDataHolder);
        ...
        mButtonColor.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                AlertDialog dialog = DialogUtil.createColorSettingDialog(getActivity(), mScanSettingDataHolder);
        ...
        mButtonFileSetting.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                AlertDialog dialog = DialogUtil.createFileSettingDialog(getActivity(), mScanSettingDataHolder);
                dialog.setOnDismissListener(new DialogInterface.OnDismissListener(){
                    @Override
                    public void onDismiss(DialogInterface paramDialogInterface) {
        ...
        mButtonSide.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                AlertDialog dialog = DialogUtil.createSideSettingDialog(getActivity(), mScanSettingDataHolder);
                dialog.setOnDismissListener(new DialogInterface.OnDismissListener(){
                    @Override
                    public void onDismiss(DialogInterface paramDialogInterface) {
        ...
        //(7)
        mButtonOther = (LinearLayout)view.findViewById(R.id.btn_other);
        mButtonOther.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                AlertDialog dialog = DialogUtil.createOtherSettingDialog(getActivity(), mScanSettingDataHolder);
        ...
        public void attributeUpdate(final ScanServiceAttributeEvent event) {
            ...
            if (OccuredErrorLevel.ERROR.equals(errorLevel)
                ...
                if (mLastErrorLevel != null) {
                    // Error -> Normal
                    if (mAlertDialogDisplayed) {
                        String activityName = getTopActivityClassName(getActivity().getPackageName());
